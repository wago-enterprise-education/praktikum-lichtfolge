...
<img src="img/render_1.jpg" alt="Platine Praktikum-Lichtfolge" width="500"><img src="img/render_3.jpg" alt="Platine Praktikum-Lichtfolge" width="500"></br>
...
<img src="img/Platinenhalter.webp" alt="Platinenhalter" width="500"></br>
...
<img src="img/ISP_Programmer.jpeg" alt="Programmierung über ISP" width="500"></br>
...
1. Arduino Projekt ([praktikum-lichtfolge](../code/praktikum-lichtfolge/)) öffnen
...
<img src="img/Arduino_IDE_Einstellungen.png" alt="Einstellungen in der Arduino IDE" width="450"></br>
...
#### Spiel 3 – Würfeln
Nach einer kurzen Zufallsanimation leuchten alle vier LEDs ein paar Mal auf. Dies entspricht der gewürfelten Zahl zwischen 1 und 6. Im Code kannst du den Zahlenbereich aber auch anpassen oder die Art der Darstellung ändern, sodass die Zahlen wie bei den Highscores angezeigt werden. So könnten auch zufällige Zahlen von 0 bis 9999 angezeigt werden.
...
> [!TIP]
> Den Schaltplan der Platine, um zu sehen welche Pins des Mikrocontrollers womit verbunden sind, findest du hier: **[Schaltplan Praktikum – Lichtfolge ➡️](../pcb/schematics_praktikum-lichtfolge.pdf)**
...
**`isPressed()`** – Gibt „true“ zurück, wenn der Taster aktuell gedrückt ist

**`released()`** – Gibt „true“ zurück, wenn der Taster losgelassen wurde
